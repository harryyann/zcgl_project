...
# 将apps加入到sources root列表中,这样写在INSTALLED_APPS中就不用加apps了
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR,'mysqlite')
    }
}
...
#部署到生产中将此选项注释，通知django首先到根目录下的static文件夹下找静态文件
STATICFILES_DIRS = [
   os.path.join(BASE_DIR, 'static')
]

# 部署到生产中将此选项注释取消,可以在浏览器直接通过static路径获取
